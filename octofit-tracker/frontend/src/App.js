          ...
          <Route path="/" element={
            <div className="p-5 mb-4 bg-light rounded-3">
              <div className="container-fluid py-5">
                ...
                <p className="col-md-8 fs-4 mx-auto">Track your activities, join teams, compete on the leaderboard, and get personalized workout suggestions. Use the navigation menu to explore features.</p>
